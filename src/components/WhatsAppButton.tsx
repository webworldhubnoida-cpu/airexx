...
export const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-8 right-8 z-40 w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center text-white shadow-2xl shadow-green-500/30 hover:scale-110 active:scale-95 transition-all group"
